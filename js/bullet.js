Bullet.max = 5; //maksymalna ilość pocisków

Bullet.all = {} //wszystkie pociski

Bullet.speed = 0.022 //szybkość pocisków

Bullet.count = 0 //ile pocisków jest wystrzelonych
Bullet.active_count = 0 //aktywne pociski (widoczne)

Bullet.life = 35 //długość lotu pocisku
