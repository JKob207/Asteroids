...
function Rock(size, x, y)
{
    ...
    this.x = x!==undefined ? x : (VAR.rand(0,1) ? VAR.rand(0,30)/100 : VAR.rand(7,100)/100*VAR.W)
    this.y = y!==undefined ? y : (VAR.rand(0,1) ? VAR.rand(0,30)/100 : VAR.rand(7,100)/100*VAR.W)
